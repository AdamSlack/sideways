...
@Injectable()
export class Participantervice {
  ...
  public requestClinicianParticipant() : Observable<Array<string>> {
    let url = this.auth.ROOT + '/Participant/clinician' + this.auth.CLINICIAN_ID;
    let headers = this.auth.createHeaders();
    return this.http.get<any>(url);
  }

  public requestParticipantTests(p_id : number) : Observable<Array<string>> {
